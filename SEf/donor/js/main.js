...
function search() {
	...
	let x = document.getElementsByClassName('col-md-4');
...
var
	mContainer = $("side_bar_and_don_req"),
	filterButton = $(".button");
params = {
	itemSelector: ".badge",
...
var currentFilters={gender:'male',type:'k'}
			...
			<div class="col-md-4" key=${key}>
					  <div class="cause shadow-sm">
						...
						<div class="px-3 pt-3 border-top-0 border border shadow-sm">
						  <div class="badge-danger py-1 small px-2 rounded mb-3 d-inline-block" class="badge School">Clothes
						  </div>
